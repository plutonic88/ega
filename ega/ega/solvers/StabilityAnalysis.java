...
import ega.solvers.CandidateEquilibriumComparisons.CompareProfileMaxDevBounds;
import ega.solvers.support.ActionData;
import ega.solvers.support.ProfileInfo;
import ega.util.GenericTensor;
...
public final class StabilityAnalysis {
  ...
  private final ega.solvers.CandidateEquilibriumComparisons.CompareProfileMaxDevBounds compDevBounds =
          new ega.solvers.CandidateEquilibriumComparisons.CompareProfileMaxDevBounds();
  ...
  public TreeSet<ProfileInfo> getMostStableProfiles(int sampleBound) {
    TreeSet<ProfileInfo> profileSet =
            new TreeSet<ProfileInfo>(new ega.solvers.CandidateEquilibriumComparisons.CompareProfileMaxDevBounds());
